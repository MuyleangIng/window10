    ...
    <div className={styles.browser} onClick={(e) => e.stopPropagation()}>
      <div className={styles.toolbar}>
        <div className={styles.tabBar}>
          <div className={styles.tab}>
            ...
            <span className={styles.tabTitle}>GitHub - IngMuyleang</span>
      ...
      <div className={styles.addressBar}>
        ...
        <div className={styles.urlBar}>
          ...
          <span className={styles.urlText}>github.com/Muyleang</span>
        </div>
      ...
      <div ref={browserContentRef} className={styles.browserContent}>
        {isLoading ? (
          ...
          <div className={styles.externalSitePrompt}>
            ...
            <h2 className={styles.externalSiteTitle}>GitHub Profile - IngMuyleang</h2>
            <p className={styles.externalSiteDescription}>
              Explore my quantum computing research, machine learning projects, and open-source contributions.
              Specializing in quantum error correction, quantum machine learning, and AI-quantum hybrid systems.
            </p>
            <a
