    ...
    <div className={styles.browser} onClick={(e) => e.stopPropagation()}>
      <div className={styles.toolbar}>
        <div className={styles.tabBar}>
          <div className={styles.tab}>
            ...
            <span className={styles.tabTitle}>Mail - IngMuyleang</span>
      ...
      <div className={styles.addressBar}>
        ...
        <div className={styles.urlBar}>
          ...
          <span className={styles.urlText}>mailto:muyleanging@gmail.com</span>
        </div>
      ...
      <div ref={browserContentRef} className={styles.browserContent}>
        {isLoading ? (
          ...
          <div className={styles.externalSitePrompt}>
            ...
            <h2 className={styles.externalSiteTitle}>Contact IngMuyleang</h2>
            <p className={styles.externalSiteDescription}>
              Get in touch for research collaborations, quantum computing projects, or academic discussions. Available
              for internships, consulting, and educational partnerships.
            </p>
            <a
              href="mailto:muyleanging@gmail.com"
              target="_blank"
