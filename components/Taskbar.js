    ...
    <div className={styles.taskbar} onClick={(e) => e.stopPropagation()}>
      <div className={styles.left}>
        ...
        <div className={styles.taskbarIcons}>
          ...
          <div
            className={`${styles.taskbarIcon} ${
              openWindows.some((w) => w.id === "vscode") ? styles.activeApp : ""
            } ${isAppMinimized("vscode") ? styles.minimizedApp : ""}`}
            onClick={() => handleOpenApp("vscode")}
            onMouseEnter={() => {
              setShowTooltip("Visual Studio Code")
              setHoveredIcon("vscode")
            }}
            onMouseLeave={() => {
              setShowTooltip(null)
              setHoveredIcon(null)
            ...
            style={{
              backgroundColor: hoveredIcon === "vscode" ? "rgba(255, 255, 255, 0.1)" : "transparent",
            }}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            {showTooltip === "Visual Studio Code" && <div className={styles.tooltip}>Visual Studio Code</div>}
          </div>
