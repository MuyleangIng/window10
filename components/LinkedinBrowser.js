    ...
    <div className={styles.browser} onClick={(e) => e.stopPropagation()}>
      <div className={styles.toolbar}>
        <div className={styles.tabBar}>
          <div className={styles.tab}>
            ...
            <span className={styles.tabTitle}>LinkedIn - IngMuyleang</span>
      ...
      <div className={styles.addressBar}>
        ...
        <div className={styles.urlBar}>
          ...
          <span className={styles.urlText}>linkedin.com/in/muyleang-ing-7977912a0/</span>
        </div>
      ...
      <div ref={browserContentRef} className={styles.browserContent}>
        {isLoading ? (
          ...
          <div className={styles.externalSitePrompt}>
            ...
            <h2 className={styles.externalSiteTitle}>LinkedIn Profile - IngMuyleang</h2>
            <p className={styles.externalSiteDescription}>
              Connect with me on LinkedIn to see my professional journey in quantum computing research, AI convergence,
              and academic achievements at PKNU and RUPP.
            </p>
            <a
